...
y1 = integration_CPBD(image1);
y2 = integration_CPBD(image2);
y3 = integration_CPBD(image3);
y4 = integration_CPBD(image4);
y5 = integration_CPBD(image5);
y6 = integration_CPBD(image6);
y7 = integration_CPBD(image7);
y8 = integration_CPBD(image8);
