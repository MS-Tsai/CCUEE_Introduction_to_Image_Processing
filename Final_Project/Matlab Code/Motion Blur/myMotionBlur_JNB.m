function output = myMotionBlur_JNB(input, theta)
    ...
    FM = JNBM_compute(uint8(motion));
    FM_1 = JNBM_compute(uint8(motion1));
    FM_2 = JNBM_compute(uint8(motion2));
    FM_3 = JNBM_compute(uint8(motion3));
    FM_4 = JNBM_compute(uint8(motion4));
    FM_5 = JNBM_compute(uint8(motion5));
    FM_6 = JNBM_compute(uint8(motion6));
    FM_7 = JNBM_compute(uint8(motion7));
    FM_8 = JNBM_compute(uint8(motion8));
    FM_9 = JNBM_compute(uint8(motion9));
    FM_10 = JNBM_compute(uint8(motion10));
